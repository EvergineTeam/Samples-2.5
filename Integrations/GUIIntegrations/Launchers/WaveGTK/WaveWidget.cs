...
#endif
    {
        ...
        protected override bool OnButtonReleaseEvent(Gdk.EventButton evnt)
        {
            if (this.input != null)
            {
                if (evnt.Button == 1) // Left mouse button
                {
                    this.input.MouseState.LeftButton = ButtonState.Released;
                }
                else if (evnt.Button == 2) // Middle mouse button
                {
                    this.input.MouseState.MiddleButton = ButtonState.Released;
                }
                else if (evnt.Button == 3) // Right mouse button
                {
                    this.input.MouseState.RightButton = ButtonState.Released;
                }
            }
