...
{
    public class ButtonsScene : Scene
    {
        /// <summary>
        /// The buttonwidth
        /// </summary>
        ...
        /// The fade in
        /// </summary>
        private SingleAnimation fadeInUI;
        ...
        {
            this.Load(WaveContent.Scenes.ButtonsScene);
            
            WaveServices.MusicPlayer.Play(new MusicInfo(WaveContent.Assets.audiodolby_mp3));
        ...
        protected override void Start()
        {
            ...
            buttonPanelAnimation.BeginAnimation(Transform2D.OpacityProperty, this.fadeInUI);

            var infoPanelAnimation = this.infoPanel.Entity.FindComponent<AnimationUI>();
            infoPanelAnimation.BeginAnimation(Transform2D.OpacityProperty, this.fadeInUI);            
        }
        ...
        private void CreateUI()
        {
            ...
            //// Animations
            this.fadeInUI = new SingleAnimation(0.0f, 1.0f, TimeSpan.FromSeconds(8), EasingFunctions.Cubic);
        }
